...
// Nullable, not NOT NULL: the hierarchy migration relaxed it because the new
// code writes group_id alone. Phase 2 drops the column and this assertion.
if (getScalar(noteCategoryColumnResult.rows, "is_nullable") !== "YES") {
  throw new Error("Expected public.user_note_v1.category_id to be nullable")
}
