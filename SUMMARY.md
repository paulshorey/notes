...
* [basic Linux server](backend/basic-linux-web-server/README.md)
  * [setup new UNIX environment](backend/basic-linux-web-server/new-ubuntu/README.md)
    * [automate setup](backend/basic-linux-web-server/new-ubuntu/automate-setup.md)
