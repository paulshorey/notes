...
{% embed url="https://medium.com/@jansalvadorsebastian/hacking-wi-fi-penetration-on-macos-bc1f0f0f6296" caption="^^^ this is the best tutorial for Mac. However..." %}

However, the above tutorial has a gap. Use the below tutorial as a supplement:
