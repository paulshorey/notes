...
const contractPath = path.resolve(repoRoot, "lib/db-notes/generated/contracts/notes-app.json")
...
const expectedCodecPattern = (field) => {
  ...
  if (field.kind === "model") {
    return new RegExp(`^[A-Za-z0-9_]+FromJson\\(json\\.getJSONObject\\("${fieldName}"\\)\\)$`)
  }
